...
###    f=flows[key]
##
###    f["packet_count"]+=flow.bidirectional_packets
##
###    f["byte_count"]+=flow.bidirectional_bytes
##
###    size=flow.bidirectional_bytes
##
...
##
###    "Flow Bytes/s":
###        f["byte_count"]/(duration+.001),
##
###    "Flow Packets/s":
###        f["packet_count"]/(duration+.001),
##
###    "Packet Length Mean":
###        np.mean(
###            f["packet_sizes"]
...
#    # Ép NFStreamer xuất dữ liệu luồng cực nhanh sau mỗi 1 giây để đạt real-time
#    streamer = NFStreamer(
#        source=interface,
#        promiscuous_mode=True,
#        active_timeout=1,  # Luồng đang chạy cứ sau 1 giây là cắt khúc đẩy ra
#        idle_timeout=1     # Luồng dừng sau 1 giây là xuất dữ liệu ngay lập tức
#    )
#
#    features = [
...
#        "application_name", "application_category_name", "tcp_flags"
#    ]
#
